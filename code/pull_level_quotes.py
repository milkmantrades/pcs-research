#!/usr/bin/env python3
"""Pull Monday ~10:00 ET SPXW quotes at weekly ATR-level strikes, 2020-05 -> now.

Per week: puts at round5(lower level) for trigger/0382/0618/0786/100 plus
K-5 (digital partner), K-25, K-50 (sim wings); calls mirrored on upper levels.
Single-threaded with heal-on-478-streak (gex/pull_quotes.py pattern).
"""
import csv
import io
import sqlite3
...
def build_plan():
    wk = pd.read_csv("/root/spy/atr_options_mispricing/spx_weekly_levels.csv",
